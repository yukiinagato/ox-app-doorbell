...
const referenced = [
  ...
  "time.sync_failed", "time.sync_succeeded", "time.sync_result_failed",
  "time.err_no_response", "time.err_bad_server", "time.err_bad_reply",
  "time.err_implausible", "time.err_rtt_unreasonable", "time.err_offset_unreasonable",
  "time.err_large_offset_confirming", "time.err_clock_changed",
  "time.ntp_off", "time.invalid_zone", "time.invalid_servers",
